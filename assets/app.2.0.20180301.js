...
app.run(['$rootScope', '$localStorage', '$http', '$filter', '$templateCache', 'amMoment', '$state', '$stateParams', '$tm1UiHelper', 'tm1UiRouter', '$location', '$urlRouter', '$timeout', '$tm1UiSetting', 'tm1UiSettings', '$window', '$log',
         function($rootScope, $localStorage, $http, $filter, $templateCache, amMoment, $state, $stateParams, $tm1UiHelper, tm1UiRouter, $location, $urlRouter, $timeout, $tm1UiSetting, tm1UiSettings, $window, $log) {
